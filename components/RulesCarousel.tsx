...
export const RULES_STEPS = [
  {
    icon: lcClapperboard,
    title: 'Draw a Card',
    body: 'Get a card randomly assigned from the digital deck or scan the QR on a physical Cinescenes card.',
    accent: C.ochre,
  },
  {
    icon: lcPopcorn,
    title: 'Watch the Clip',
    body: 'No title. No year. Just a part of the trailer. Try to figure out when it was released.',
    accent: C.cerulean,
  },
  {
    icon: lcLightning,
    title: 'Know It? Say It',
    body: 'Tap "I know it!" to skip straight to guessing. If you are not sure, keep watching.',
    accent: C.vermillion,
  },
  {
    icon: lcCoin,
  ...
  },
  {
    ...
    body: "Every player begins with one random card already on their timeline. On your first turn it's simple — the new card goes either before or after that one.",
    accent: C.leaf,
  },
  {
    icon: lcHourglass,
    title: 'Place It Right',
    body: 'Place the card into your timeline — oldest on the left, newest on the right. The more cards you collect, the trickier it gets!',
    accent: C.cerulean,
  },
  {
    icon: '⚔️',
    title: 'Challenge!',
    body: 'After the active player places their card, everyone else has 10 seconds to challenge. Think they got it wrong? Tap Challenge and pick where you think the card belongs.',
    accent: C.vermillion,
  },
  {
    icon: lcSpotlight,
    title: 'The Reveal',
    body: "The card flips and the correct year is shown. If the active player is right, they keep the card. If a challenger was right, the card goes to them instead. If nobody was right, the card is trashed.",
    accent: C.cerulean,
  },
  {
    icon: lcTrophy,
    title: 'Race to Win',
    body: 'The first one to get to 10 cards wins!',
    accent: C.ochre,
  },
];
